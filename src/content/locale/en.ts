export const en = {
  "/": {},
  "/cart": {
    hello: "Your shopping cart",
    labelEmpty: "No products in cart",
    confirmMessageRemove: "Do you really want to remove the product?",
    confirmButtonText: "Yes",
    denyButtonText: "Cancel",
    successRemoveMessage: "Product Removed!",
    removeLabel: "Remove",
